import { SALES_DEALS_QUERY, SALES_DEAL_STAGES_QUERY } from '@/graphql/queries';
import { SalesDealStagesQuery, SalesDealsQuery } from '@/graphql/types';
...
export const SalesPage: FC<PropsWithChildren> = ({ children }) => {
  ...
  const stageGrouped = useMemo(() => {
    ...
    //all the deals whose stageId is null goes to unassigned stage.
